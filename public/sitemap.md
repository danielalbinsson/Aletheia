...
Agent-facing map of Aletheia. Prefer Markdown URLs; HTML routes are the human showcase SPA.

## Discovery

- [llms.txt](/llms.txt) — curated index for AI agents
- [llms-full.txt](/llms-full.txt) — inlined cornerstone docs
- [AGENTS.md](/AGENTS.md) — install, config, usage for coding agents
